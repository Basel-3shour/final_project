...
<main>
    <div class="container1">
      <div class="up">
        ...
        <div class="cont1">
          <h2 class="hd1">عن دكان</h2>
          <p>دكان هو متجر الكتروني تم انشائه عام٢٠٢٢ من قبل طلاب كلية </p>
          <p>Front-End</p>

          <p>الحاسبات والذكاء الاصطناعي بجامعة حلوان القاهرة الكبرى وتم تصميمه</p>
          <p>كمشروع   لمادة تكنولجيا المعلومات</p>
          <p>Back-End</p>
          <p>تم نصميمه من قبل الطالب :باسل عاشور</p>

          <p>كمشروع   لمادة ويب 2</p>
          <p>تحت اشراف د:بدران عوض</p>

        </div>
        <div>
          <video controls class="vid1">
            <source src="{{asset('dist/img/CAPX.mp4')}}" type="video/mp4">
          </video>
        </div>
        <div>
        </div>
      ...
      <div class="down">
        <div class="cont2">
          <h2 class="hd1">فريق العمل</h2>
          <p>فريق عمل موقع دكان من طلاب كلية الحاسبات والذكاء الاصطناعي بجامعة</p>
          <p>حلوان بالقاهرة الكبرى</p>
          <p>وأحد طلاب كلية فلسطين التقنية</p>
          <p>وهو باسل عاشور</p>
